...
public enum PropertyBlockFacings implements IStringSerializable {
      ...
      public static final EnumSet ALL_AND_NONE = EnumSet.of(All, None);
      public static final EnumSet FACES = EnumSet.of(Face_D, Face_E, Face_N, Face_S, Face_U, Face_W);
      public static final EnumSet ANGLES = EnumSet.of(Angle_DE, Angle_DN, Angle_DS, Angle_DW, Angle_EN, Angle_ES, Angle_EU, Angle_NU, Angle_NW, Angle_SU, Angle_SW, Angle_UW);
      public static final EnumSet OPPOSITES = EnumSet.of(Opposite_DU, Opposite_EW, Opposite_NS);
      public static final EnumSet CSHAPES = EnumSet.of(CShape_DEU, CShape_DEW, CShape_DNS, CShape_DNU, CShape_DSU, CShape_DUW, CShape_ENS, CShape_ENW, CShape_ESW, CShape_EUW, CShape_NSU, CShape_NSW);
      public static final EnumSet CORNERS = EnumSet.of(Corner_DEN, Corner_DES, Corner_DNW, Corner_DSW, Corner_ENU, Corner_ESU, Corner_NUW, Corner_SUW);
      public static final EnumSet MISCELLANEA = EnumSet.of(Misc_DENS, Misc_DENU, Misc_DENW, Misc_DESU, Misc_DESW, Misc_DNSW, Misc_DNUW, Misc_DSUW, Misc_ENSU, Misc_ENUW, Misc_ESUW, Misc_NSUW);
      public static final EnumSet PIPES = EnumSet.of(Pipe_DEUW, Pipe_DNSU, Pipe_ENSW);
      public static final EnumSet PIPEENDS = EnumSet.of(PipeEnd_DENSU, PipeEnd_DENSW, PipeEnd_DENUW, PipeEnd_DESUW, PipeEnd_DNSUW, PipeEnd_ENSUW);
      final byte _hash;
      ...
      private PropertyBlockFacings(byte hash) {
            this._hash = hash;
